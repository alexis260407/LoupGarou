...
- **This README is extracted from the [original repository by Leomelki](https://github.com/leomelki/LoupGarou/blob/master/README.md) which [has been archived as of 2024-12-01](https://github.com/leomelki/LoupGarou/issues/71)**.

- **Its content is saved here for posterity in case the original repository gets deleted**

- **So bear in mind the information listed below such as the in-game commands `might differ` from what is really implemented in this repository**.

# END OF DISCLAIMER #

README copied from: https://github.com/leomelki/LoupGarou/blob/master/README.md as of 2024-12-05

## Table des matières

- [DISCLAIMER](#disclaimer)
- [END OF DISCLAIMER](#end-of-disclaimer)
  ...
  - [À propos](#à-propos-1)
  - [Jouer facilement](#jouer-facilement-1)
  - [Installation](#installation-1)
    - [Dépendances requises](#dépendances-requises-1)
    - [Installation classique](#installation-classique-1)
    - [Installation avec docker (Alternative)](#installation-avec-docker-alternative-1)
      - [Installation du serveur](#installation-du-serveur-1)
      - [Démarage du serveur](#démarage-du-serveur-1)
...
- [License](#license)
    - [Questions fréquentes](#questions-fréquentes-1)
  - [Indications pour les développeurs](#indications-pour-les-développeurs-1)
    - [Ajouter des rôles](#ajouter-des-rôles-1)
      - [Quelques classes utiles](#quelques-classes-utiles-1)
    - [Publier un rôle](#publier-un-rôle-1)
- [License](#license-1)
